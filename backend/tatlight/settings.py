#tatlight/settings.py
"""
Django settings for Tatlight project.
"""
...
ROOT_URLCONF = 'tatlight.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'tatlight', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tatlight.wsgi.application'
...
# Use PostgreSQL in production (set DATABASE_URL or individual settings)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@tatlight.com')
