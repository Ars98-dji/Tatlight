    ...
    <footer className="bg-[#0D1B2A] border-t border-[#D4AF37]/20 mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* Réseaux sociaux */}
          <div>
            <h3 className="text-[#D4AF37] font-semibold mb-4">Réseaux</h3>
            <div className="flex flex-col gap-3">
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/60 hover:text-[#25D366] transition-colors text-sm">
                <FaWhatsapp className="w-4 h-4" />
                WhatsApp
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/60 hover:text-[#25F4EE] transition-colors text-sm">
                <FaTiktok className="w-4 h-4" />
                TikTok
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/60 hover:text-[#E4405F] transition-colors text-sm">
          ...
          {/* Légal */}
          <div>
            <h3 className="text-[#D4AF37] font-semibold mb-4">Légal</h3>
            <div className="flex flex-col gap-2">
              <Link to="/confidentialite" className="text-white/60 hover:text-[#D4AF37] transition-colors text-sm">
                Politique de confidentialité
              </Link>
              <Link to="/conditions" className="text-white/60 hover:text-[#D4AF37] transition-colors text-sm">
                Termes et conditions
              </Link>
              <Link to="/securite" className="text-white/60 hover:text-[#D4AF37] transition-colors text-sm">
                Sécurité
              </Link>
            </div>
          </div>
