  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-white py-20 text-center">
        ...
        <Link to="/" className="text-[#D4AF37]">Retour à l'accueil</Link>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Finaliser Votre <span className="text-[#D4AF37]">Achat</span></h1>
            ...
            <div className="order-2 lg:order-1">
              <div className="p-8 bg-gradient-to-br from-[#D4AF37]/5 to-transparent border border-[#D4AF37]/20 rounded-3xl">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  <Lock className="w-6 h-6 text-[#D4AF37]" /> Informations de Paiement
                </h2>

                <form onSubmit={handlePayment} className="space-y-6">
                  <div className="p-4 bg-gradient-to-br from-[#D4AF37]/5 to-transparent border border-[#D4AF37]/20 rounded-2xl">
                  ...
                  <button type="submit" disabled={processing} className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#D4AF37] text-[#0D1B2A] rounded-full font-bold text-lg hover:glow-gold transition-all group disabled:opacity-50">
            ...
            <div className="order-1 lg:order-2">
              <div className="p-8 bg-gradient-to-br from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/30 rounded-3xl sticky top-24">
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-2xl">
                  <div className="flex gap-4">
                    {product.image ? (
                      ...
                      <div className="w-20 h-20 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center"><Sparkles className="w-8 h-8 text-[#D4AF37]/50" /></div>
                    )}
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-[#D4AF37] text-3xl font-bold">{total.toFixed(2)}€</span>
                </div>
                <div className="space-y-3 p-4 bg-[#D4AF37]/5 rounded-2xl border border-[#D4AF37]/20 mb-6">
                  <div className="flex items-center gap-3 text-gray-700"><Check className="w-5 h-5 text-[#D4AF37]" /><span>Téléchargement instantané</span></div>
                  <div className="flex items-center gap-3 text-gray-700"><Check className="w-5 h-5 text-[#D4AF37]" /><span>Accès illimité à vie</span></div>
                  <div className="flex items-center gap-3 text-gray-700"><Check className="w-5 h-5 text-[#D4AF37]" /><span>Mises à jour gratuites</span></div>
                  <div className="flex items-center gap-3 text-gray-700"><Check className="w-5 h-5 text-[#D4AF37]" /><span>Support client dédié</span></div>
                </div>
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-[#D4AF37]/20 to-[#D4AF37]/5 rounded-2xl border border-[#D4AF37]/30">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#D4AF37] rounded-full flex items-center justify-center"><Gift className="w-5 h-5 text-[#0D1B2A]" /></div>
